...
The QR code was invented in 1994 for industrial applications. The current version, described in \cite{isoqr}, is dated February 2015.
...
From a historical-geographical point of view, this area is identified with the \emph{Lima} stream and its tributaries, which impress the area with peculiar geomorphology, impervious despite the modest hilly elevations.
...
In light of the above, a reflection on \textit{community-involved tourism} perspective is needed. As shown by this empirical study, a small village like \emph{Casoli} requires a valorization strategy that takes advantage of the wider local tourism context. 
...
To allow readability in {\em dead zones} and quickly provide the information without further steps to web pages, we encode the content within the QR code itself. The content consists of a text of an average of 460 characters aiming at concise and effective communication with the tourist.

Therefore, in our design, the information encoded in the QR tag is the primary or only way of communication with the visitor. It is a new and original way of using such technology since QR tags are instead considered ancillary to other forms of communication, like physical installations or linked Web contents, according with to motto "analog portal to the digital world", as in the title of \cite{bai12a}. 
...
From a medium-term perspective, the description of the deployed experiment gives suggestions for the development of new devices or features for existing ones. In our case, a new potential application may foster research aiming at passive or very low-energy devices that can effectively advertise their presence or simply collect statistics in \emph{dead-zones}.
...
{\textbf{Augusto Ciuffoletti} Former teacher and researcher at the University of Pisa, retired on September 2023, with recent achievements on the Internet of Things and distributed control, with an interest on low-power devices. Previously active on Grid and, later, Cloud computing in collaboration with INFN. Until 2023, he was a teacher at the Degree Course in Computer Humanities at the University of Pisa, where he taught two courses, one on Network Protocols and the other on the Angular 2+ framework.}
