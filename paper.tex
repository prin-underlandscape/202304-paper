...
Although tourism persistently targets most renowned sites, like art cities and parks, there is an increasing interest for targets not exposed to mass tourism, that may provide a more intense and inner experience. Suh an exclusive flavor is appreciated not only by the occasional visitor, which helps the economy of the corner, but also by those that have their homes in such privileged location. The key to sustain such a difficult equilibrium is to guide the visitor to enjoy the place with discrete messages that he finds on his way.
